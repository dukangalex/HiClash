 ...
 * 作者：dukangalex
 * 源仓库：https://github.com/dukangalex/MyClash
 * 脚本链接：https://raw.githubusercontent.com/dukangalex/MyClash/main/Script/mihomoScript.js
...
const rateRegionDefinitions = [
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Available.svg',
  },
  {
    name: highRateRegionName,
    regex:
      /(?<=[ \[\(|｜丨∣┃\-‐–—−－﹣])((?:[*×✕✖⨯⨉x]\s*(?:[2-9]\d*|[1-9]\d+)(?:\.\d+)?)|(?:(?<![\d.])(?:[2-9]\d*|[1-9]\d+)(?:\.\d+)?\s*(?:倍|[*×✕✖⨯⨉x])))/i,
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Airport.svg',
  },
];
...
const urlTestBaseOption = {
  ...
  tolerance: 50,
  'exclude-type': 'DIRECT',
  icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Auto.svg',
  hidden: true,
};
...
const loadBalanceBaseOption = {
  ...
  'exclude-type': 'DIRECT',
  icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/RoundRobin.svg',
  hidden: true,
};
...
const baseGroups = [
  {
    ...
    includeAll: true,
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Static.svg',
  },
  {
    name: '自动选择',
...
const serviceConfigs = [
  ...baseGroups,
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Fcm.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/YouTube.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Google.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/ChatGPT.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Microsoft.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Apple.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Telegram.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Steam.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/TikTok.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Twitter.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Meta.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Line.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Netflix.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Emby.svg',
    rules: [
      'RULE-SET,emby,Emby',
      'RULE-SET,emos,Emby',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Pikpak.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Spotify.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Bitcoin.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Ehentai.svg',
  ...
  },
  {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/AdBlock.svg',
...
function buildRegionGroups(filteredProxies, customProxies) {
  ...
  if (otherProxies.length > 0) {
    generatedRegionGroups.push(
      ...createRegionGroup(
        '其他节点',
        'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/WorldMap.svg',
        otherProxies,
      ),
    );
  }
...
function buildCustomizeGroups(filteredProxies, customizeList = customizeProxies) {
  ...
  const customGroup = {
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Server.svg',
  };
...
function buildFunctionalGroups(filteredProxies, generatedRegionGroups, customizeInfo) {
  ...
  const chainGroup =
    chainEnabled && customGroup
      ? {
          ...
          icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Bypass.svg',
        }
      : null;
  ...
  if (minimalModeEnabled) {
    const defaultGroup = {
      ...
      icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Proxy.svg',
    };
    const finalRuleProviders = { ...baseRuleProviders };
    ...
    const directGroup = {
      ...
      icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/China.svg',
      hidden: true,
    };
    const globalGroup = {
      ...selectBaseOption,
      ...
      icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Global.svg',
    };
    return {
      globalGroup,
  ...
  functionalGroups.push({
    ...
    icon: 'https://fastly.jsdelivr.net/gh/dukangalex/MyClash@main/Icons/svg/Stack.svg',
  });
