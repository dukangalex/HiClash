...
const regionDefinitions = [
  ...
  { name: "🇦🇪 阿联酋节点", flag: "🇦🇪", regex: new RegExp("🇦🇪|阿联酋|迪拜|阿布扎比|dubai|abu[\s_-]*dhabi|uae|united[\\s_-]*arab[\\s_-]*emirates", "i"), icon: "" },
  ...
  { name: "🇨🇴 哥伦比亚节点", flag: "🇨🇴", regex: new RegExp("🇨🇴|哥伦比亚|波哥大|麦德林|bogota|medellin|colombia", "i"), icon: "" },
