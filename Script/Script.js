...
const regionDefinitions = [
  ...
  { name: '美国', flag: '🇺🇸', regex: new RegExp("🇺🇸|美国|\\bUSA?\\b|america|united[\\s_-]*states|los[\\s_-]*angeles|洛杉矶|san[\\s_-]*jose|圣何塞", "i"), icon: '' },
  ...
  { name: '马来西亚', flag: '🇲🇾', regex: new RegExp("🇲🇾|马来西亚|\\bMY\\b|malaysia|kuala[\\s_-]*lumpur|吉隆坡", "i"), icon: '' },
  { name: '泰国', flag: '🇹🇭', regex: new RegExp("🇹🇭|泰国|\\bTH\\b|thailand|bangkok|曼谷", "i"), icon: '' },
  { name: '越南', flag: '🇻🇳', regex: new RegExp("🇻🇳|越南|\\bVN\\b|vietnam|hanoi|河内|ho[\\s_-]*chi[\\s_-]*minh|胡志明", "i"), icon: '' },
  { name: '菲律宾', flag: '🇵🇭', regex: new RegExp("🇵🇭|菲律宾|\\bPH\\b|philippines|manila|马尼拉", "i"), icon: '' },
  { name: '印尼', flag: '🇮🇩', regex: new RegExp("🇮🇩|印尼|印度尼西亚|\\bID\\b|indonesia|jakarta|雅加达", "i"), icon: '' },
  { name: '印度', flag: '🇮🇳', regex: new RegExp("🇮🇳|印度|\\bIN\\b|india|mumbai|孟买|delhi|德里", "i"), icon: '' },
  { name: '澳大利亚', flag: '🇦🇺', regex: new RegExp("🇦🇺|澳大利亚|澳洲|\\bAU\\b|australia|sydney|悉尼|melbourne|墨尔本", "i"), icon: '' },
  ...
  { name: '阿根廷', flag: '🇦🇷', regex: new RegExp("🇦🇷|阿根廷|\\bAR\\b|argentina|buenos[\\s_-]*aires|布宜诺斯艾利斯", "i"), icon: '' },
  ...
  { name: '沙特阿拉伯', flag: '🇸🇦', regex: new RegExp("🇸🇦|沙特阿拉伯|沙特|\\bSA\\b|saudi[\\s_-]*arabia", "i"), icon: '' },
  { name: '南非', flag: '🇿🇦', regex: new RegExp("🇿🇦|南非|\\bZA\\b|south[\\s_-]*africa|johannesburg|约翰内斯堡", "i"), icon: '' },
  ...
  { name: '柬埔寨', flag: '🇰🇭', regex: new RegExp("🇰🇭|柬埔寨|\\bKH\\b|cambodia|phnom[\\s_-]*penh|金边", "i"), icon: '' },
  ...
  { name: '罗马尼亚', flag: '🇷🇴', regex: new RegExp("🇷🇴|罗马尼亚|\\bRO\\b|romania|bucharest|布加勒斯特", "i"), icon: '' },
  ...
  { name: '佛得角', flag: '🇨🇻', regex: new RegExp("🇨🇻|佛得角|\\bCV\\b|cabo[\\s_-]*verde|cape[\\s_-]*verde", "i"), icon: '' },
  { name: '喀麦隆', flag: '🇨🇲', regex: new RegExp("🇨🇲|喀麦隆|\\bCM\\b|cameroon", "i"), icon: '' },
  { name: '中非共和国', flag: '🇨🇫', regex: new RegExp("🇨🇫|中非共和国|中非|\\bCF\\b|central[\\s_-]*african", "i"), icon: '' },
  ...
  { name: '刚果民主共和国', flag: '🇨🇩', regex: new RegExp("🇨🇩|刚果民主共和国|刚果（金）|民主刚果|\\bCD\\b|dr[\\s_-]*congo|democratic[\\s_-]*republic[\\s_-]*of[\\s_-]*the[\\s_-]*congo", "i"), icon: '' },
  { name: '科特迪瓦', flag: '🇨🇮', regex: new RegExp("🇨🇮|科特迪瓦|象牙海岸|\\bCI\\b|cote[\\s_-]*d.ivoire|ivory[\\s_-]*coast", "i"), icon: '' },
  { name: '吉布提', flag: '🇩🇯', regex: new RegExp("🇩🇯|吉布提|\\bDJ\\b|djibouti", "i"), icon: '' },
  { name: '埃及', flag: '🇪🇬', regex: new RegExp("🇪🇬|埃及|\\bEG\\b|egypt|cairo|开罗", "i"), icon: '' },
  { name: '赤道几内亚', flag: '🇬🇶', regex: new RegExp("🇬🇶|赤道几内亚|\\bGQ\\b|equatorial[\\s_-]*guinea", "i"), icon: '' },
  { name: '厄立特里亚', flag: '🇪🇷', regex: new RegExp("🇪🇷|厄立特里亚|\\bER\\b|eritrea", "i"), icon: '' },
  { name: '斯威士兰', flag: '🇸🇿', regex: new RegExp("🇸🇿|斯威士兰|埃斯瓦蒂尼|\\bSZ\\b|eswatini|swaziland", "i"), icon: '' },
  ...
  { name: '几内亚比绍', flag: '🇬🇼', regex: new RegExp("🇬🇼|几内亚比绍|\\bGW\\b|guinea-bissau|guinea[\\s_-]*bissau", "i"), icon: '' },
  ...
  { name: '圣多美和普林西比', flag: '🇸🇹', regex: new RegExp("🇸🇹|圣多美和普林西比|\\bST\\b|sao[\\s_-]*tome", "i"), icon: '' },
  ...
  { name: '阿联酋', flag: '🇦🇪', regex: new RegExp("🇦🇪|阿联酋|迪拜|阿布扎比|dubai|abu[\s_-]*dhabi|uae|united[\\s_-]*arab[\\s_-]*emirates", "i"), icon: '' },
  ...
  { name: '波斯尼亚和黑塞哥维那', flag: '🇧🇦', regex: new RegExp("🇧🇦|波斯尼亚和黑塞哥维那|bosnia|bosnia[\\s_-]*and[\\s_-]*herzegovina", "i"), icon: '' },
  ...
  { name: '圣基茨和尼维斯', flag: '🇰🇳', regex: new RegExp("🇰🇳|圣基茨和尼维斯|saint[\\s_-]*kitts|st[\\s_-]*kitts", "i"), icon: '' },
  { name: '圣卢西亚', flag: '🇱🇨', regex: new RegExp("🇱🇨|圣卢西亚|saint[\\s_-]*lucia|st[\\s_-]*lucia", "i"), icon: '' },
  { name: '圣文森特和格林纳丁斯', flag: '🇻🇨', regex: new RegExp("🇻🇨|圣文森特和格林纳丁斯|saint[\\s_-]*vincent|st[\\s_-]*vincent", "i"), icon: '' },
  { name: '特立尼达和多巴哥', flag: '🇹🇹', regex: new RegExp("🇹🇹|特立尼达和多巴哥|trinidad[\\s_-]*and[\\s_-]*tobago", "i"), icon: '' },
  { name: '安提瓜和巴布达', flag: '🇦🇬', regex: new RegExp("🇦🇬|安提瓜和巴布达|antigua[\\s_-]*and[\\s_-]*barbuda", "i"), icon: '' },
  { name: '哥伦比亚', flag: '🇨🇴', regex: new RegExp("🇨🇴|哥伦比亚|波哥大|麦德林|bogota|medellin|colombia", "i"), icon: '' },
  ...
  { name: '新西兰', flag: '🇳🇿', regex: new RegExp("🇳🇿|新西兰|new[\\s_-]*zealand|auckland|奥克兰|wellington|惠灵顿", "i"), icon: '' },
  { name: '斐济', flag: '🇫🇯', regex: new RegExp("🇫🇯|斐济|fiji", "i"), icon: '' },
  { name: '巴布亚新几内亚', flag: '🇵🇬', regex: new RegExp("🇵🇬|巴布亚新几内亚|papua[\\s_-]*new[\\s_-]*guinea", "i"), icon: '' },
  ...
  { name: '密克罗尼西亚', flag: '🇫🇲', regex: new RegExp("🇫🇲|密克罗尼西亚|micronesia|federated[\\s_-]*states[\\s_-]*of[\\s_-]*micronesia", "i"), icon: '' },
  ...
  { name: '英属维尔京群岛', flag: '🇻🇬', regex: new RegExp("🇻🇬|英属维尔京群岛|british[\\s_-]*virgin[\\s_-]*islands", "i"), icon: '' },
  { name: '美属维尔京群岛', flag: '🇻🇮', regex: new RegExp("🇻🇮|美属维尔京群岛|us[\\s_-]*virgin[\\s_-]*islands|u\\.s\\.[\\s_-]*virgin[\\s_-]*islands", "i"), icon: '' },
